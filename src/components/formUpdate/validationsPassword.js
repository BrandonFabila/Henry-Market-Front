...
export default function validations(values) {
    ...
    if (values.password && values.password.length < 8) errors.password = 'Minimo 8 caracteres'
    if (values.password && values.password.length > 20) errors.password = 'Maximo 20 caracteres'    
    ...
    if (values.password && !values.confirmPassword) errors.confirmPassword = 'Debes confirmar la contraseña'
